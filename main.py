    ...
    if name == 'Reset':
        if os.path.isfile('score.txt'):
            if os.path.isfile('old_score.txt'):
                print('There is already a file named "old_score.txt". Kindly check the file and delete it if you want to reset the score.')
                time.sleep(5)
            else:
        ...
        if os.path.isfile('old_score.txt'):
            ...
            print('There is no file named "old_score.txt".')
        time.sleep(3)
    else:
        break
