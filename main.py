...
if is_admin():
    ...
    set_of_questions_and_answers = {'Governor of RBI: ': 'Shakti Kanta Das',
                                    ...
                                    'First female PM of India: ': 'Indira Gandhi',
    ...
    hat didn’t get a single hair on his head wet. How: ": 'He was bald', 'What gets wet while drying: ': 'Towel',
     ...
     an oil lamp, and a log of firewood. What do you light first?: ': 'The match - Can’t light any of those things \
     without a lit match',
                                    'Three doctors all say Robert is their brother. Robert says he has no brothers. \
                                    Who is lying?: ':
                                    ...
                                    'I called my dog from the opposite side of the river. The dog crossed the river \
                                    without getting wet, and without using a bridge, a boat, or a raft. How is that \
                                    possible?: ': 'The river was frozen',
                                    'What two words, added together, contain the most letters?: ': 'Post office',
                                    'Bella is outside a shop. She can’t read the signs, but she knows she needs to go \
                                    in to make a purchase. What store is she at?: ': 'An eyeglasses store',
                                    'Wednesday, Bill and Jim went to a restaurant they ordered and ate their food and \
                                    stuff like that. Then they paid the bill, \
                                    but neither Bill nor Jim paid the bill. Who did?: ': 'Wednesday did',
                                    'A man was driving his truck. His lights weren’t on. The moon was not out.\
     There were no streetlights. Up ahead, a woman was crossing the street. Luckily, the truck driver stopped in time—\
     how did he see her?: ': 'It was daytime',
    ...
    umbrella or a hat. His clothes got soaked, but not a hair on his head was wet. How is this possible?: ':
                                                 'Grandpa’s bald',
    ...
    What place are you in now?: ': 'Second place',
    ...
    but never come inside. What am I?: ': 'A street', 'You go at red and stop at green. What am I?: ': 'A watermelon',
                                              ...
                                              what comes next?: ':
                                                  'E N T The letters are the first letters of the written numbers \
    ...
    It comes back to her, even though nothing and nobody touches it. How?: ': 'She throws it straight up in the air',
                                              ...
                                              'How can the number four be half of five?: ':
                                                  'IV the Roman numeral for four is “half” \
    ...
    def display_tutorial(to_delay=True):
        ...
        instructions = ['Welcome to Pyzzle.', 'This is a puzzle game, coded entirely in Python.',
                        ...
                        'In some of the questions, you also might have to answer within the given time limit, else you \
                        will lose.', 'The objective is to answer all the questions correctly in the least time.',
                        'Get Ready.']
